  ...
  return (
    <View style={styles.sidebar}>
      <View style={styles.sidebarBrand}>
        <View style={styles.sidebarMark}><Text style={styles.sidebarMarkText}>A</Text></View>
  ...
  return (
    <View style={styles.mobileHeader}>
      <View style={styles.mobileBrandRow}>
        <View style={styles.mobileMark}><Text style={styles.mobileMarkText}>A</Text></View>
  ...
  return (
    <Modal visible={visible} animationType="slide" onRequestClose={onClose}>
      <SafeAreaView style={styles.scannerScreen}>
        <View style={styles.scannerHeader}><View><Text style={styles.scannerTitle}>Scan product code</Text><Text style={styles.scannerCopy}>QR, barcode, serial label, or a product URL.</Text></View><Pressable onPress={onClose} style={styles.scannerClose}><Text style={styles.scannerCloseText}>×</Text></Pressable></View>
...
const styles = StyleSheet.create({ // NOSONAR
  ...
  brandMark: { width: 64, height: 64, borderRadius: 22, backgroundColor: palette.forest, alignItems: 'center', justifyContent: 'center' },
  brandMarkText: { color: palette.white, fontSize: 36, fontWeight: '800' },
